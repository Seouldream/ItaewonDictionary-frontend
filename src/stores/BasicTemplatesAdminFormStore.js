...
export default class BasicTemplatesAdminFormStore extends Store {
  ...
  async fetchBasicTemplates() {
    this.basicTemplates = await basicTemplatesAdminApiService.fetchBasicTemplates();
  ...
  async updateBasicTemplate(id, updatedBasicTemplate) {
    await basicTemplatesAdminApiService.updateBasicTemplate(id, updatedBasicTemplate);
